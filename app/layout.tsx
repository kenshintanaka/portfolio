...
export const metadata: Metadata = {
  ...
  description: 'Hey, I\'m Julian. I build cool stuff on the web. Check out my projects!',
  keywords: ['Julian Maggio', 'Web Developer', 'React', 'Next.js', 'JavaScript', 'Portfolio'],
  ...
  openGraph: {
    ...
    description: 'Web developer crafting digital experiences. Come see what I\'ve been working on!',
    images: [{ url: '/api/og' }]
  },
  twitter: {
